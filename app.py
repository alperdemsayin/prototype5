...
def inject_custom_css() -> None:
    st.markdown(
        ...
        <style>
        .stApp {
            background: linear-gradient(180deg, #edf4f7 0%, #f8fbfd 100%);
            color: #0f172a;
        }
...
def render_plant_map(active_rows: List[Dict], depot: Dict) -> None:
    fig = go.Figure()
...
def render_solution_map(result: Dict, active_rows: List[Dict], depot: Dict) -> None:
...
def render_one_solution(result: Dict, active_rows: List[Dict], depot: Dict, rank: int = 1) -> None:
    ...
    with tab1:
        render_solution_map(result, active_rows, depot)
...
def render_home() -> None:
    ...
    with right:
        ...
        render_plant_map(active_rows, FIXED_SCENARIO["depot"])
...
def render_plant_map_page() -> None:
    ...
    with right:
        ...
        render_plant_map(active_rows, depot)
